...
# # from mmseg.models.backbones import SwinTransformer, SwinTransformer3D, SwinTransformer3Dv2, SwinTransformer3Dv3
#
...
#     if isinstance(model, swin_transformer.SwinTransformer):
...
#     elif isinstance(model, swin_transformer_3d_v3.SwinTransformer3Dv3):
