...
def main():
    ...
    for fold in range(args.folds):
        ...
        checkpoint = load_checkpoint(model, args.checkpoint.replace('hsy', f'{fold}'), map_location='cpu')
        ...
        if not distributed:
            ...
            outputs = single_gpu_test(model, data_loader, args.show, args.show_dir.replace('hsy', f'{fold}'),
                                      efficient_test)
        else:
