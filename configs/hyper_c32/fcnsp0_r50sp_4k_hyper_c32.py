...
model = dict(
    backbone=dict(norm_cfg=norm_cfg,in_channels=32),
    decode_head=dict(num_classes=2,norm_cfg=norm_cfg,num_sp=0,sp_s=8),
    auxiliary_head=dict(num_classes=2,norm_cfg=norm_cfg,num_sp=0,sp_s=8))
